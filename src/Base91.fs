...
type Base91 private ( configuration : BinaryToTextConfiguration ) =
    ...
    static let defaultInstance = lazy Base91( defaultCharacterSet )
    ...
    /// (Default) Excludes " ' \ characters, ASCII-sortable: !#$%&()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[]^_`abcdefghijklmnopqrstuvwxyz{|}~
    ...
    new
        (
            ...
            Base91( BinaryToTextConfiguration ( 91 , characterSet , useCrLfNewline , true ) )
